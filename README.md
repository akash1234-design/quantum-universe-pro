...
![Data Analytics Dashboard](assets/01_data_analytics_dashboard.png)
**KPIs:** Total Galaxies 3,000 | Avg Redshift 0.43 | Avg Mass 6.28e+10 M☉ | Spiral % 58.6%

### 2. Exoplanet Explorer — Real NASA Data
![Exoplanet Explorer](assets/02_exoplanet_explorer.png)
...
![Big Bang Timeline](assets/03_big_bang_timeline.png)
Interactive slider with Era detection and Scale Factor

### 4. 3D Galaxy Universe
![3D Galaxy Universe](assets/04_3d_galaxy_universe.png)
3,000 galaxies with redshift coloring

### 5. Supermassive Black Hole
![Black Hole](assets/05_supermassive_black_hole.png)
